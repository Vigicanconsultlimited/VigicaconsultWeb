...
export default function StudentDashboard({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        console.log(
          `Dashboard: Fetching data at 2025-08-05 14:43:48 by NeduStack`
        );
        ...
        console.log(
          `Dashboard: Loaded ${
            availableRes?.data?.result?.length || 0
          } programs at 2025-08-05 14:43:48 by NeduStack`
        );
      } catch (err) {
  ...
  const onStartApplication = (school, description) => {
    console.log(
      `Starting application for ${school} - ${description} at 2025-08-05 14:43:48 by NeduStack`
    );
            ...
            {availableApplications.length > 0 && (
              <>
                ...
                <button
                  ...
                  onClick={() =>
                    onStartApplication("Default University", "General Program")
                  }
                >
