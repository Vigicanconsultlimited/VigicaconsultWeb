    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className="d-flex flex-column align-items-center justify-content-center px-3 px-md-5 py-4 bg-white reset-password-form-container"
            style={{
              width: "100%",
              maxWidth: "400px",
              boxShadow: "0 2px 16px rgba(34,53,176,0.09)",
              borderRadius: "18px",
              margin: "0 auto",
            }}
          >
